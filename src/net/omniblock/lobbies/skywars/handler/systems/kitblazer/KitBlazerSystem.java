...
public class KitBlazerSystem implements LobbySystem {
	...
	public  String[] textAnimationWithDeath = new String[]{
			...
			"&b&l 1%", "&b&l 5%", "&b&l 8%", 
			"&b&l 12%", "&b&l 15%","&b&l 18%", 
			"&b&l 20%", "&b&l 22%", "&b&l 26%",
			"&b&l 30%","&b&l 34%", "&b&l 38%",
			"&b&l 41%", "&b&l 45%", "&b&l 49%",
			"&b&l 54%", "&b&l 57%", "&b&l 65%",
			"&b&l 67%", "&b&l 69%", "&b&l 73%",
			"&b&l 83%", "&b&l 86%", "&b&l 89%",
			"&b&l 96%", "&b&l 98%", "&b&l 99%",
						"&4&l 100%"
	};
	...
	public void setup(Lobby lobby) {
		...
		if(lobby instanceof SkywarsLobby) {
			...
			beama = CitizensAPI.getNPCRegistry().createNPC(EntityType.GUARDIAN, TextUtil.format("&cMaterializador &7(#1)"));
			beamb = CitizensAPI.getNPCRegistry().createNPC(EntityType.GUARDIAN, TextUtil.format("&cMaterializador &7(#2)"));
		...
		new BukkitRunnable() {
			...
			public void run() {
				...
				if(start >= 4) { 
					...
					effect.setLocation(blaze.getEntity().getLocation());
					effect.setTargetLocation(player.getLocation());
					...
					block.getWorld().dropItemNaturally(block.getLocation().clone().add(NumberUtil.getRandomInt(-5, 5), 6, NumberUtil.getRandomInt(-5, 5)),  new ItemBuilder(Material.BLAZE_POWDER).amount(1).build());
					block.getWorld().dropItemNaturally(block.getLocation().clone().add(NumberUtil.getRandomInt(-5, 5), 6, NumberUtil.getRandomInt(-5, 5)),  new ItemBuilder(Material.BLAZE_POWDER).amount(1).build());
					block.getWorld().dropItemNaturally(block.getLocation().clone().add(NumberUtil.getRandomInt(-5, 5), 6, NumberUtil.getRandomInt(-5, 5)),  new ItemBuilder(Material.BLAZE_POWDER).amount(1).build());
					block.getWorld().dropItemNaturally(block.getLocation().clone().add(NumberUtil.getRandomInt(-5, 5), 6, NumberUtil.getRandomInt(-5, 5)),  new ItemBuilder(Material.BLAZE_ROD).amount(1).build());
					block.getWorld().dropItemNaturally(block.getLocation().clone().add(NumberUtil.getRandomInt(-5, 5), 6, NumberUtil.getRandomInt(-5, 5)),  new ItemBuilder(Material.BLAZE_ROD).amount(1).build());
					block.getWorld().dropItemNaturally(block.getLocation().clone().add(NumberUtil.getRandomInt(-5, 5), 6, NumberUtil.getRandomInt(-5, 5)),  new ItemBuilder(Material.BLAZE_ROD).amount(1).build());
					block.getWorld().dropItemNaturally(block.getLocation().clone().add(NumberUtil.getRandomInt(-5, 5), 6, NumberUtil.getRandomInt(-5, 5)),  new ItemBuilder(kit.getMaterial()).amount(1).build());
					block.getWorld().dropItemNaturally(block.getLocation().clone().add(NumberUtil.getRandomInt(-5, 5), 6, NumberUtil.getRandomInt(-5, 5)),  new ItemBuilder(kit.getMaterial()).amount(1).build());
					block.getWorld().dropItemNaturally(block.getLocation().clone().add(NumberUtil.getRandomInt(-5, 5), 6, NumberUtil.getRandomInt(-5, 5)),  new ItemBuilder(kit.getMaterial()).amount(1).build());
					...
					new BukkitRunnable() {
						...
						public void run() {
							...
							hud.setName(TextUtil.format(textAnimationWithDeath[round]));
